\begin{tikzpicture}%[x=1pt,y=1pt]
    ...
    % Schwann Cell
    \draw[<-] (75.5\rs,-1.5\rs) -- (84\rs,-10\rs);
    \node[anchor=north west,inner sep=1\rs] at (84\rs,-10\rs) {Schwann Cell};
    % Myelin Sheath
    \draw[<-] (50\rs,-4\rs) -- (66\rs,-20\rs);
    \node[anchor=north west,inner sep=1\rs] at (66\rs,-20\rs) {Myelin Sheath};
\end{tikzpicture}
